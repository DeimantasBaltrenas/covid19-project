...
COVID-19 Data Integration, Analysis, and Visualization project is a platform that pulls data from Snowflake, enriches it with external economic and demographic data, exposes it through an API, and visualizes it through an interactive dashboard, including forecasting and clustering, with supplementary annotations stored in MongoDB.
